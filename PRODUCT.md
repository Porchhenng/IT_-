...
- Owner's core stack, from the site: NestJS, Vendure, FastAPI, GraphQL/REST, Redis, PostgreSQL, Docker; FCM and AWS CloudWatch; KHQR/ABA and PayWay integrations. Add from the NBC role: **load testing (k6) and Appium, used for mobile testing**.
